...
def start(request, id):
    ...
    return render(request, 'list/start.html', {'lib': lib, 'form':form, 'lib_type_list': lib_type_list})
...
def show(request, id):
    ...
    return render(request, 'list/show.html', {'lib': lib, 'story': story})
